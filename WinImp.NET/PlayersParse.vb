...
Module PlayersParse
	...
	Public currentPlayersNumber() As Short
	...
	'1 player
	Public Sub ParsePlayers(ByRef strLine As String)
		...
		If Val(Mid(strLine, 12, 2)) <> CountryNumber Then
			...
			ReDim Preserve currentPlayersNumber((UBound(currentPlayersNumber) + 1))
			ReDim Preserve currentPlayersName((UBound(currentPlayersName) + 1))
		End If
	End Sub
